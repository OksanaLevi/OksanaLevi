<h1 align="center">Привет! Меня зовут Оксана
...
<ul>
	...
	<li>Owner для конфигурации проекта (в планах добавить)</li>
	<li>Кастомные отчеты в Allure для API запросов (в планах добавить)</li>
